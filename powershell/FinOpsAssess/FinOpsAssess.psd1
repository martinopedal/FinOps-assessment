@{
    ...
    FunctionsToExport      = @('Assert-FinOpsReadOnlyScope', 'Export-FinOpsFocusAligned', 'Export-FinOpsPlaybook', 'Get-FinOpsInfo', 'Invoke-FinOpsAssessment', 'Invoke-FinOpsTriage', 'Test-FinOpsConfiguration', 'Test-FinOpsReadOnlyScope')
    CmdletsToExport        = @()
    VariablesToExport      = @()
    AliasesToExport        = @()
